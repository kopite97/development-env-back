...
final class TaskRequestHash {
    private TaskRequestHash() {}
    static String of(CreateTaskCommand command) {
        try {
            ...
            throw new IllegalStateException("Cannot fingerprint task request", impossible);
        }
    }
}
