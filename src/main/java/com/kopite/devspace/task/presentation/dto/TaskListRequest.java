...
public record TaskListRequest(String scope,String projectId,String projectStatus,String query,String status,
    ...
    public TaskListFilter filter() {
        ...
        return new TaskListFilter(scope,TaskRequestFields.uuid(projectId,"projectId"),projectStatus,query,status,
