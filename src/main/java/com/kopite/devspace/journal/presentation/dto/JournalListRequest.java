...
public record JournalListRequest(String scope,String projectId,String projectStatus,String query,String from,String to,String sort,int limit) {
    public JournalListFilter filter() {
        return new JournalListFilter(scope,JournalRequestFields.uuid(projectId,"projectId"),projectStatus,query,
