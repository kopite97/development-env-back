...
@Constraint(validatedBy = JournalText.Validator.class)
public @interface JournalText {
    ...
    class Validator implements ConstraintValidator<JournalText, String> {
        private JournalText rule;
        @Override public void initialize(JournalText rule) { this.rule = rule; }
