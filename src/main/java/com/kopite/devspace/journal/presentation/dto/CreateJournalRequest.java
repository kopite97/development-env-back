...
public record CreateJournalRequest(
    @JournalText(max=120,required=true,trim=true) @Schema(maxLength=120,requiredMode=Schema.RequiredMode.REQUIRED) String title,
    @NotNull @Schema(type="string",format="uuid") String projectId,
    @JournalText(max=20000,required=true) @Schema(maxLength=20000,requiredMode=Schema.RequiredMode.REQUIRED) String body,
