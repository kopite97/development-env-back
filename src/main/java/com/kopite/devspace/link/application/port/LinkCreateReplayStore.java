...
public interface LinkCreateReplayStore {
    record Replay(String requestHash, LinkMutation result, Instant expiresAt, boolean legacy) {
        public Replay(String requestHash, LinkMutation result, Instant expiresAt) { this(requestHash,result,expiresAt,false); }
    }
